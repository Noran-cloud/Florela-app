...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      : GridView.builder(
                itemCount: categories?.tulips.length ?? 0,
                ...
                itemBuilder: (context,index){
                  final item = categories!.tulips[index];
                  print("Tulip image path: ${item.image}");
                         ...
                         child: Column(
                          children: [
                            ClipRRect(
                              ...
                              child: AspectRatio(aspectRatio: 1,child: Image.asset(item.image,height: 200,width: double.infinity,fit: BoxFit.cover,))),
                            SizedBox(height: 10,),
                            Text(item.title,style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),),
